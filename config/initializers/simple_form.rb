...
SimpleForm.setup do |config|
  ...
  config.button_class = 'btn btn-submit'
    ...
    class FileInput < Base
      def input(_wrapper_options)
        ...
        button = template.content_tag(:div, class: 'input-group') do
          template.tag(:input, id: "pbox_#{idf}", class: 'form-control', type: 'text') +
            template.content_tag(:span, class: 'input-group-btn') do
              content_tag(:a, "Browse", class: 'btn btn-default', onclick: "$('input[id=#{idf}]').click();")
            end
        end
